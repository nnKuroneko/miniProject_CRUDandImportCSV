...
<table class="body-wrap">
    ...
    <tbody><tr>
		...
		//$query = mysqli_query($mysqli, "SELECT payment_reminder.id,payment_reminder.name,payment_reminder.lastname,payment_reminder.house_number,payment_reminder.arrears"
                ...
                $query = "SELECT * FROM incomeandexpenses WHERE id ='$b_id'";    
		...
		$fetch = mysqli_fetch_array($result);
                ...
                $totalin = $fetch['income'] - $fetch['expenses'];
                $totalexp = $fetch['income'] - $fetch['expenses'];
		...
		echo "<tbody><tr>";
                echo "<td>เดือน : ".$fetch['month']." <br>ไอดีบิล #".$fetch['id']."</td></tr>";
                echo "<tr>";
                echo "<td>";
		...
		echo "<td>รายรับ</td>";
		echo "<td class='alignright'>  ".$fetch['income']." บาท</td> </tr>";
                echo "<td>รายจ่าย</td>";
		echo "<td class='alignright'>  ".$fetch['expenses']." บาท</td> </tr>";		
                echo "<tr class='total'>";
                
                if($income > $expenses){
                    echo "<td class='alignleft' width='80%'>กำไรทั้งหมด</td>";
                  echo "<td class='alignright'>".$totalin." บาท</td>";
                }if($income < $expenses){
                    echo "<td class='alignleft' width='80%'>ขาดทุนทั้งหมด</td>";
                  echo "<td class='alignright'>".$totalexp." บาท</td>";
                }
